...
3. 为什么 Flutter 选择了 Dart 语言 https://zhengchao.link/post/flutter/why-flutter-uses-dart/
...
1. BLoC 模式入门 https://zhengchao.link/post/flutter/getting-started-with-the-bloc-pattern/
